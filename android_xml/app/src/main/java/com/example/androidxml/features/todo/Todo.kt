...
val dummyTodos = listOf(
    ...
    Todo(id = "3", title = "Navigation Component で画面遷移", priority = TodoPriority.LOW),
    Todo(id = "4", title = "Retrofit で API 通信", priority = TodoPriority.MEDIUM),
